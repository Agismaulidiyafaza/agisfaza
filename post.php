...
<body>
    ...
    <div class="mx-[20%] mb-5">
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            ?>
                <a href="delete.php?foto_id=<?= $foto_id ?>" onclick="return confirm('Apakah anda yakin?')" class="w-full py-1 px-2 bg-red-600 text-white rounded-md mt-1  text-lg text-md hover:bg-red-500 transition-all">Delete</a>
                </div>
            <?php
            }
        } else {
